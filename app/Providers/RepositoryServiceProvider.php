...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->app->bind(\App\Contracts\Repositories\GroupRepository::class, \App\Repositories\Eloquents\GroupRepositoryEloquent::class);
        $this->app->bind(\App\Contracts\Repositories\GroupUserRepository::class, \App\Repositories\Eloquents\GroupUserRepositoryEloquent::class);
